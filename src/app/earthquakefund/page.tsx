        ...
        <Section>
          <div className="text-center max-w-6xl mx-auto px-4 sm:px-6">
            ...
            <p className="prose-muted text-base sm:text-lg md:text-xl mb-6 sm:mb-8 leading-relaxed text-white/90 drop-shadow-md max-w-4xl mx-auto">
              Hits central Philippines. SparkCreatives Volunteers help families in need across Bogo and San Remigio, Cebu by distributing meals to provide immediate relief and hope for recovery.
            </p>
        ...
        <Section id="how-it-works" kicker="How it works" title="From crisis to hope">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20">
              ...
              <h3 className="font-display2 text-lg sm:text-xl mb-2 sm:mb-3 text-white">Crisis Identified</h3>
            ...
            <div className="text-center bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 border border-white/20">
              ...
              <h3 className="font-display2 text-lg sm:text-xl mb-2 sm:mb-3 text-white">Recovery Support</h3>
              <p className="prose-muted text-sm sm:text-base text-white/80">
