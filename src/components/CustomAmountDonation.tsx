...
interface CustomAmountDonationProps {
  campaign: string;
...
export default function CustomAmountDonation({ 
  campaign, 
  defaultAmount = 25,
  onSuccess,
  onError 
}: CustomAmountDonationProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h3 className="text-white font-display2 text-xl mb-2">Custom Amount</h3>
        <p className="text-white/70 text-sm">Choose your donation amount and make a direct impact</p>
      </div>
      ...
      <form onSubmit={handleAmountSubmit} className="space-y-6">
        ...
        <GlowButton
          ...
          className="w-full text-center py-4 text-lg font-semibold"
        >
          {isLoading ? (
